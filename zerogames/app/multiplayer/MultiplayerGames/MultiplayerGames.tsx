...
import ClientGamesMultiplayer from './Client/Client'
...
export default async function MultiplayerGames() {

    const categoryGames : theGames = await getCategoryGames(1, 'Multiplayer')
